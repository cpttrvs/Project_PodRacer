...
namespace Leap.Unity {
  ...
  public class CapsuleHand : HandModelBase {
    ...
    private static Color[] _leftColorList = { new Color(1.0f, 0f, 0f)/*new Color(0.0f, 0.0f, 1.0f), new Color(0.2f, 0.0f, 0.4f), new Color(0.0f, 0.2f, 0.2f)*/ };
    private static Color[] _rightColorList = { new Color(1.0f, 0f, 0f)/*new Color(1.0f, 0.0f, 0.0f), new Color(1.0f, 1.0f, 0.0f), new Color(1.0f, 0.5f, 0.0f)*/ };
